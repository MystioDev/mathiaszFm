...
!(function (e, t) {
  ...
  function G(e) {
    ...
    const y =
      s.params.loop && !(s.virtual && s.params.virtual.enabled) && !r.cssMode;
    if (!i.isMoved) {
      if (
  ...
  const ce = [
    ...
    function (e) {
      ...
      function l(e, s) {
        ...
        (e = r(e)).forEach((e) => {
          e &&
            (e.classList[s ? "add" : "remove"](a.disabledClass),
      ...
      function u() {
        ...
        const a = (e, s) => {
          e.removeEventListener("click", "next" === s ? c : d),
            e.classList.remove(t.params.navigation.disabledClass);
        };
